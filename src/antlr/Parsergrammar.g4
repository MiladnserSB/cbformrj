...
//mod
importBody:
IDENTIFIER|CROISNN|COMPONENT|INJECTABLE;
//mod
componentDecorator:
AT COMPONENT LPAREN LBRACE componentProperties? RBRACE RPAREN ;
//mod
componentProperties:
(selector COMMA)? (imports COMMA)? (templateurl COMMA) styleurl?;
...
templateurl:
TEMPLATEURL COLON STRING_LITERAL;
