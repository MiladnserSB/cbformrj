...
public interface ParsergrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Parsergrammar#tsDocumentStatement}.
	 * @param ctx the parse tree
	 */
	void enterTsDocumentStatement(Parsergrammar.TsDocumentStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link Parsergrammar#tsDocumentStatement}.
	 * @param ctx the parse tree
	 */
	void exitTsDocumentStatement(Parsergrammar.TsDocumentStatementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Parsergrammar#ngOnInitBody}.
	 * @param ctx the parse tree
	 */
	void enterNgOnInitBody(Parsergrammar.NgOnInitBodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link Parsergrammar#ngOnInitBody}.
	 * @param ctx the parse tree
	 */
	void exitNgOnInitBody(Parsergrammar.NgOnInitBodyContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code HtmlContentSequence}
	 * labeled alternative in {@link Parsergrammar#htmlContent}.
	 * @param ctx the parse tree
	 */
	void enterHtmlContentSequence(Parsergrammar.HtmlContentSequenceContext ctx);
	/**
	 * Exit a parse tree produced by the {@code HtmlContentSequence}
	 * labeled alternative in {@link Parsergrammar#htmlContent}.
	 * @param ctx the parse tree
	 */
	void exitHtmlContentSequence(Parsergrammar.HtmlContentSequenceContext ctx);
	/**
