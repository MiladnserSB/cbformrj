...
public interface ParsergrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Parsergrammar#ngOnInitBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNgOnInitBody(Parsergrammar.NgOnInitBodyContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code HtmlContentSequence}
	 * labeled alternative in {@link Parsergrammar#htmlContent}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlContentSequence(Parsergrammar.HtmlContentSequenceContext ctx);
	/**
